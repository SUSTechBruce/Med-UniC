...
DATA_BASE_DIR = os.path.join(os.path.dirname(
    os.path.abspath(__file__)), "../MGCA_dataset")
...
# RSNA constants
# #############################################
RSNA_DATA_DIR = DATA_BASE_DIR / "RSNA"
...
# #############################################
# SIIM constants
PNEUMOTHORAX_DATA_DIR = DATA_BASE_DIR / "SIIM"/ "pneumothorax"
...
OBJ_TRAIN_IMG_PATH = OBJ_DATA_DIR / "train" / "train"
OBJ_VALID_IMG_PATH = OBJ_DATA_DIR / "train" / "train"
OBJ_TEST_IMG_PATH = OBJ_DATA_DIR / "dev" / "dev"